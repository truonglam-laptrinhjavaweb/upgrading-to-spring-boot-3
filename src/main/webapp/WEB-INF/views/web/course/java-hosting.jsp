...
<div id="wrap">
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-auto col-lg-2">
                    <img src="https://slimweb.vn/builder/images/modal-loader.gif" data-src="/template/course/javahosting/images/user/22607/logoawebsite.png" class="lazy mw-100" alt="" style="max-height: 50px;">
                </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-8 ml-auto mr-auto" style="">
                <h2 style="color: rgb(1, 60, 92); font-size: 2em;" class="mb-30 text-center slim_relative"><b class="">Video giới thiệu khóa học deploy project java web jsp servlet spring mvc spring boot lên hosting</b></h2>
                <a href="https://www.youtube.com/watch?v=nji0cB3Py1w" target="_self" class="smooth video-popup mfp-iframe"><img class="lazy shadow mw-100 mb-30" width="800" alt="image" src="https://slimweb.vn/builder/images/modal-loader.gif" data-src="/template/course/javahosting/images/user/22607/bannerakhoaahocajavaahosting.jpg" style="box-shadow: rgb(162, 170, 177) 0px 0px 10px;"></a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 ml-auto mr-auto" style="">
                <h4 class="mb-20 slim_relative" style="">Nếu xem video vẫn chưa đã</h4>
...
<section id="sep-bottom-3--0" class="section-sep sep-bottom light">
    ...
    <div class="">
        <img class="lazy w-100" src="https://slimweb.vn/builder/images/modal-loader.gif" data-src="/template/course/javahosting/images/user/22607/bigaimageakhoaahocajavaahosting.png" alt="header img">
    </div>
</header>
    ${model.content2}
    ${model.content3}
   ...
   <section id="tool-social-right--0" class="tool-social-right text-center light">
    <div class="morestats collapse show" style="position: fixed; right: 0px; bottom: 110px;">
        ...
        <div class="content-box bg-default shadow padding rounded-circle mb-10" style="background-color: rgb(0, 192, 255);">
            <a href="https://zalo.me/4588194011921423842" target="_blank" class="smooth"><img src="https://slimweb.vn/builder/images/modal-loader.gif" data-src="/template/course/javahosting/images/user/887/imagezaloicon.png" height="30" width="30" class="lazy icon" alt="icon" style="fill: rgb(255, 255, 255);"></a>
