...
<head>
    ...
    <link rel="stylesheet" href="<c:url value='/template/course/javaweb/css/fonts.css' />" />
    <link rel="stylesheet" href="<c:url value='/template/course/javaweb/css/bootstrap.weber.css' />" />
    <link rel="stylesheet" href="<c:url value='/template/course/javaweb/css/fx.css' />" />
    <link rel="stylesheet" href="<c:url value='/template/course/javaweb/css/magnific-popup.css' />" />
    <link rel="stylesheet" href="<c:url value='/template/course/javaweb/css/custom.css' />" />
    <link rel="stylesheet" href="<c:url value='/template/course/javaweb/css/index.css' />" />
    <link rel="stylesheet" href="<c:url value='/template/course/javaweb/css/index1666714963.css' />" />
    ...
    <!-- Script Popup -->
    <script src="https://salekit.io/embed/js/0b3c020b" async="async"></script>
...
<div id="wrap">
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-auto col-lg-2">
                    <img src="https://slimweb.vn/builder/images/modal-loader.gif" data-src="/template/course/javaweb/images/user/22607/logoawebsite.png" class="lazy mw-100" alt="" style="max-height: 50px;">
                </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-8 ml-auto mr-auto" style="">
                <h2 style="color: rgb(1, 60, 92); font-size: 2em;" class="mb-30 text-center"><b class="">Video giới thiệu nội dung khoá học java web online core cơ bản nâng cao spring mvc spring boot spring framework</b></h2>
                <a href="https://www.youtube.com/watch?v=tqa7hrKtPvI" target="_self" class="smooth video-popup mfp-iframe"><img class="lazy shadow mw-100 mb-30" width="800" alt="image" src="https://slimweb.vn/builder/images/modal-loader.gif" data-src="/template/course/javaweb/images/user/22607/javaaweb.png" style="box-shadow: rgb(162, 170, 177) 0px 0px 10px;"></a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 ml-auto mr-auto" style="">
                ...
                <h4 style="" class="mb-30 slim_relative"><span style="text-transform: uppercase;" class=""><b class="">hãy đọc tiếp các nội dung phía dưới</b></span></h4>
    ...
    <div class="">
        <img class="lazy w-100" src="https://slimweb.vn/builder/images/modal-loader.gif" data-src="/template/course/javaweb/images/user/22607/mucdichasaukhoahoca01.png" alt="header img">
    </div>
</header>
    ${model.content2}
    ${model.content3}
    ...
    ${model.content13}<section id="tool-social-right--0" class="tool-social-right text-center light">
    <div class="morestats collapse show" style="position: fixed; right: 0px; bottom: 110px;">

        <div class="content-box bg-default shadow padding rounded-circle mb-10" style="background-color: rgb(0, 192, 255);">
            <a href="https://zalo.me/4588194011921423842" target="_blank" class="smooth"><img src="https://slimweb.vn/builder/images/modal-loader.gif" data-src="/template/course/javaweb/images/user/887/imagezaloicon.png" height="30" width="30" class="lazy icon" alt="icon" style="fill: rgb(255, 255, 255);"></a>
        ...
        <div class="content-box bg-default shadow padding rounded-circle mb-10" style="background-color: rgb(255, 156, 0);">
            <a href="tel:0354502773" class="smooth" target="_blank"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 512 512" enable-background="new 0 0 64 64" class="icon" style="fill: rgb(255, 255, 255);"><path d="M493.397 24.615l-104-23.997c-11.314-2.611-22.879 3.252-27.456 13.931l-48 111.997a24 24 0 0 0 6.862 28.029l60.617 49.596c-35.973 76.675-98.938 140.508-177.249 177.248l-49.596-60.616a24 24 0 0 0-28.029-6.862l-111.997 48C3.873 366.516-1.994 378.08.618 389.397l23.997 104C27.109 504.204 36.748 512 48 512c256.087 0 464-207.532 464-464 0-11.176-7.714-20.873-18.603-23.385z" class=""></path></svg></a>
...
<script src="<c:url value='/template/course/javaweb/js/jquery-2.1.4.min.js' />"></script>
<script src="<c:url value='/template/course/javaweb/js/bootstrap.min.js' />"></script>
<script src="<c:url value='/template/course/javaweb/js/vinno1.js' />"></script>
<script src="<c:url value='/template/course/javaweb/js/jquery.magnific-popup.min.js' />"></script>
<script src="<c:url value='/template/course/javaweb/js/jquery.smooth-scroll.min.js' />"></script>
<script src="<c:url value='/template/course/javaweb/js/custom.js' />"></script>
<script src="<c:url value='/template/course/javaweb/js/index1666714963.js' />"></script>
<script src="<c:url value='/template/course/javaweb/js/index.js' />"></script><script type='text/javascript' src='https://slimweb.vn/shop/include/jquery.mycart2.js'></script>
