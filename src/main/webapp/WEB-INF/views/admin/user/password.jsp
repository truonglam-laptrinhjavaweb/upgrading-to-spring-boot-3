                    ...
                    <div id="profile">
                        <form:form id="formChangePassword" class="form-horizontal" name="formChangePassword">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"><spring:message code="label.password.old"/></label>
                                <div class="col-sm-9">
                            ...
                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"><spring:message code="label.password.new"/></label>
                                <div class="col-sm-9">
                            ...
                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"><spring:message code="label.password.repeat"/></label>
                                <div class="col-sm-9">
